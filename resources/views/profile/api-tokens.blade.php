...
@section('content')
    <div class="mx-auto max-w-4xl pb-12">
        ...
        <div class="mb-6 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
            ...
            <a href="{{ route('api-docs') }}" class="inline-flex items-center gap-1.5 self-start sm:self-center text-xs font-semibold text-indigo-700 bg-indigo-50 hover:bg-indigo-100 border border-indigo-200/80 rounded-xl px-3.5 py-2 transition shadow-xs">
