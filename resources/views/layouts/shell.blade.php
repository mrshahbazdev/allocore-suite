...
<div class="min-h-full flex">
    ...
    <aside class="hidden lg:flex lg:flex-col w-64 shrink-0 bg-slate-900 text-slate-200">
        ...
        <nav class="flex-1 px-3 py-4 space-y-1 overflow-y-auto">
            ...
            <a href="{{ route('tool-analyzer.index') }}"
               class="flex items-center gap-3 rounded-lg px-3 py-2 text-sm font-medium {{ request()->routeIs('tool-analyzer.index') ? 'bg-indigo-600 text-white' : 'hover:bg-slate-800' }}">
