        ...
        <div>
            ...
            <div x-show="groups.admin"  class="mt-2 space-y-4">
                ...
                <div class="space-y-1">
                    ...
                    <x-sidebar-link route="admin.brand-colors.index" icon="M9.53 16.122a3 3 0 00-5.78 1.128 2.25 2.25 0 01-2.4 2.245 4.5 4.5 0 008.4-2.245c0-.399-.078-.78-.22-1.128zm0 0a15.998 15.998 0 003.388-1.62m-5.043-.025a15.994 15.994 0 011.622-3.395m3.42 3.42a15.995 15.995 0 004.764-4.648l3.876-5.814a1.151 1.151 0 00-1.597-1.597l-5.814 3.876a15.996 15.996 0 00-4.648 4.764m3.42 3.42l-3.42-3.42">{{ __('Brand Colors') }}</x-sidebar-link>
                    <x-sidebar-link route="admin.dataforseo.index" icon="M3.75 3A1.5 1.5 0 002.25 4.5v15A1.5 1.5 0 003.75 21h4.5a1.5 1.5 0 001.5-1.5v-15a1.5 1.5 0 00-1.5-1.5h-4.5zm9 0A1.5 1.5 0 0011.25 4.5v15a1.5 1.5 0 001.5 1.5h4.5a1.5 1.5 0 001.5-1.5v-15a1.5 1.5 0 00-1.5-1.5h-4.5z">{{ __('DataForSEO') }}</x-sidebar-link>
                    <x-sidebar-link route="admin.gemini.index" icon="M12 2.25c-5.385 0-9.75 4.365-9.75 9.75s4.365 9.75 9.75 9.75 9.75-4.365 9.75-9.75S17.385 2.25 12 2.25zM12.75 9a.75.75 0 00-1.5 0v2.25H9a.75.75 0 000 1.5h2.25V15a.75.75 0 001.5 0v-2.25H15a.75.75 0 000-1.5h-2.25V9z">{{ __('Gemini') }}</x-sidebar-link>
