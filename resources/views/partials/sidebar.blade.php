...
<nav class="flex h-full flex-col px-3 py-4 space-y-5 overflow-y-auto">
    ...
    @if ($isAdmin)
        <div>
            <p class="px-3 text-[10px] font-semibold uppercase tracking-wider text-slate-500">{{ __('Administration') }}</p>
            <div class="mt-1.5 space-y-1">
                ...
                <x-sidebar-link route="admin.blog.posts.index" icon="M12 7.5h1.5m-1.5 3h1.5m-7.5 3h7.5m-7.5 3h7.5m3-9h3.375c.621 0 1.125.504 1.125 1.125V18a2.25 2.25 0 01-2.25 2.25M16.5 7.5V18a2.25 2.25 0 002.25 2.25M16.5 7.5V4.875c0-.621-.504-1.125-1.125-1.125H4.125C3.504 3.75 3 4.254 3 4.875V18a2.25 2.25 0 002.25 2.25h13.5M6 7.5h3v3H6v-3z">{{ __('Blog Posts') }}</x-sidebar-link>
                <x-sidebar-link route="admin.pages.index" icon="M19.5 14.25v-2.625a3.375 3.375 0 00-3.375-3.375h-1.5A1.125 1.125 0 0113.5 7.125v-1.5a3.375 3.375 0 00-3.375-3.375H8.25m2.25 0H5.625c-.621 0-1.125.504-1.125 1.125v17.25c0 .621.504 1.125 1.125 1.125h12.75c.621 0 1.125-.504 1.125-1.125V11.25a9 9 0 00-9-9z">{{ __('CMS Pages') }}</x-sidebar-link>
                ...
                <x-sidebar-link route="admin.users.index" icon="M15 19.128a9.38 9.38 0 002.625.372 9.337 9.337 0 004.121-.952 4.125 4.125 0 00-7.533-2.493M15 19.128v-.003c0-1.113-.285-2.16-.786-3.07M15 19.128v.106A12.318 12.318 0 018.624 21c-2.331 0-4.512-.645-6.374-1.766l-.001-.109a6.375 6.375 0 0111.964-3.07M12 6.375a3.375 3.375 0 11-6.75 0 3.375 3.375 0 016.75 0zm8.25 2.25a2.625 2.625 0 11-5.25 0 2.625 2.625 0 015.25 0z">{{ __('Users & Teams') }}</x-sidebar-link>
                <x-sidebar-link route="admin.modules.index" icon="M11.42 15.17L17.25 21A2.652 2.652 0 0021 17.25l-5.877-5.877M11.42 15.17l2.496-3.03c.317-.384.74-.626 1.208-.766M11.42 15.17l-4.655-5.226a2.984 2.984 0 00-.72-1.283 2.985 2.985 0 00-1.584-.859 3.004 3.004 0 00-1.747.186 2.948 2.948 0 00-1.178.84L1.5 12l2.755-2.795a4.984 4.984 0 012.105-1.35 4.995 4.995 0 012.91-.187c.929.18 1.78.595 2.43 1.167M6.75 12h.008v.008H6.75V12zm0 3h.008v.008H6.75V15zm0 3h.008v.008H6.75V18z">{{ __('Modules') }}</x-sidebar-link>
                <x-sidebar-link route="admin.plans.index" icon="M2.25 18.75a60.07 60.07 0 0115.797 2.101c.727.198 1.453-.342 1.453-1.106V8.78M2.25 18.75c.936.135 1.905.211 2.9.211M2.25 18.75c.657.097 1.335.145 2.04.145M18.75 9.286V6.375a2.25 2.25 0 00-1.244-2.013l-2.9-1.449A2.25 2.25 0 0012 2.25a2.25 2.25 0 00-2.1 1.663l-2.9 1.449A2.25 2.25 0 005.625 6.375v2.91M18.75 9.286h-3.375M5.625 9.286h3.375m6.75-6.896v4.5">{{ __('Bundles & Pricing') }}</x-sidebar-link>
                <x-sidebar-link route="admin.landing.index" icon="M2.25 12l8.954-8.955c.44-.439 1.152-.439 1.591 0L21.75 12M4.5 9.75v10.125c0 .621.504 1.125 1.125 1.125H9.75v-4.875c0-.621.504-1.125 1.125-1.125h2.25c.621 0 1.125.504 1.125 1.125V21h4.125c.621 0 1.125-.504 1.125-1.125V9.75M8.25 21h8.25">{{ __('Landing Page') }}</x-sidebar-link>
                <x-sidebar-link route="admin.appearance.index" icon="M4.098 19.902a3.75 3.75 0 005.304 0l6.401-6.402M6.75 21A3.75 3.75 0 013 17.25V4.125C3 3.504 3.504 3 4.125 3h5.25c.621 0 1.125.504 1.125 1.125v4.072M6.75 21a3.75 3.75 0 003.75-3.75V8.197M6.75 21h13.125c.621 0 1.125-.504 1.125-1.125v-5.25c0-.621-.504-1.125-1.125-1.125h-4.072M10.5 8.197l2.804-2.804a2.25 2.25 0 013.182 0l2.804 2.804a2.25 2.25 0 010 3.182l-2.804 2.804m-5.986-5.986l5.986 5.986">{{ __('Appearance') }}</x-sidebar-link>
                <x-sidebar-link route="admin.settings.index" icon="M9.594 3.94c.09-.542.56-.94 1.11-.94h2.593c.55 0 1.02.398 1.11.94l.213 1.281c.063.374.313.686.645.87.074.04.147.083.22.127.324.196.72.257 1.075.124l1.217-.456a1.125 1.125 0 011.37.49l1.296 2.247a1.125 1.125 0 01-.26 1.431l-1.003.827c-.293.24-.438.613-.431.992a6.759 6.759 0 010 .255c-.007.378.138.75.43.99l1.005.828c.424.35.534.954.26 1.43l-1.298 2.247a1.125 1.125 0 01-1.369.491l-1.217-.456c-.355-.133-.75-.072-1.076.124a6.57 6.57 0 01-.22.128c-.331.183-.581.495-.644.869l-.213 1.28c-.09.543-.56.941-1.11.941h-2.594c-.55 0-1.02-.398-1.11-.94l-.213-1.281c-.062-.374-.312-.686-.644-.87a6.52 6.52 0 01-.22-.127c-.325-.196-.72-.257-1.076-.124l-1.217.456a1.125 1.125 0 01-1.369-.49l-1.297-2.247a1.125 1.125 0 01.26-1.431l1.004-.827c.292-.24.437-.613.43-.992a6.932 6.932 0 010-.255c.007-.378-.138-.75-.43-.99l-1.004-.828a1.125 1.125 0 01-.26-1.43l1.297-2.247a1.125 1.125 0 011.37-.491l1.216.456c.356.133.751.072 1.076-.124.072-.044.146-.087.22-.128.332-.183.582-.495.644-.869l.214-1.281z">{{ __('Settings') }}</x-sidebar-link>
            </div>
        </div>
    @endif
