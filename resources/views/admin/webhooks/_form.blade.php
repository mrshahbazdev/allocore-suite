...
<div>
    ...
    <input name="events" value="{{ old('events', isset($webhook) ? implode(', ', $webhook->events ?? []) : '') }}" placeholder="{{ __('user.created, invoice.paid') }}" class="mt-2 block w-full rounded-lg border-slate-300 px-3 py-2 text-sm shadow-sm focus:border-indigo-500 focus:ring-indigo-500">
