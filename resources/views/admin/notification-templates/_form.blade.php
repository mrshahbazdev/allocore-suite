...
<div>
    ...
    <input name="variables" value="{{ old('variables', isset($notificationTemplate) ? implode(', ', $notificationTemplate->variables ?? []) : '') }}" placeholder="{{ __('name, email, team_name') }}" class="mt-2 block w-full rounded-lg border-slate-300 px-3 py-2 text-sm shadow-sm focus:border-indigo-500 focus:ring-indigo-500">
