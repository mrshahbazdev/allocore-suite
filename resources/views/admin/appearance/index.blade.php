        ...
        <div class="space-y-6">
            ...
            <div class="rounded-xl border border-slate-200 bg-white p-6 shadow-sm">
                ...
                <template x-for="(item, index) in menu" :key="index">
                    <div class="mt-3 flex gap-2">
                        <input type="text" :name="`public_nav_menu[${index}][label]`" x-model="item.label" placeholder="{{ __('Label') }}" class="block w-1/3 rounded-lg border-slate-300 text-sm">
                        <input type="text" :name="`public_nav_menu[${index}][url]`" x-model="item.url" placeholder="{{ __('URL') }}" class="block flex-1 rounded-lg border-slate-300 text-sm">
