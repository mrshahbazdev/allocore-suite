...
class CoreSeeder extends Seeder
{
    public function run(): void
    {
        ...
        $modules = [
            ...
            ['key' => 'time-butler', 'name' => 'Time Check', 'description' => 'Employee vacation, absence & time tracking with team calendar.', 'icon' => 'clock', 'route_prefix' => 'timebutler'],
            ...
            ['key' => 'sop-builder', 'name' => 'SOP Builder', 'description' => 'Create, manage and execute standard operating procedures with checklists, training quizzes and audit evidence.', 'icon' => 'clipboard-document-check', 'route_prefix' => 'sopbuilder'],
        ];
        ...
        $plans = [
            ...
            ['name' => 'All Tools Bundle', 'slug' => 'all-tools', 'price_monthly' => 99.99, 'price_yearly' => 999, 'modules' => ['invoice-maker', 'audit', 'keyword-cluster', 'lead-quality', 'time-butler', 'plan-hive', 'kpi-tool', 'loop-engine', 'smart-kpi', 'cash-core', 'dental-track', 'focus-matrix', 'org-matrix', 'vision-flow', 'nur-du', 'financial-platform', 'sweet-spot', 'sop-builder']],
