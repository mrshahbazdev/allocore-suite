        ...
        <form method="POST" action="{{ route('clusterforge.update', $cluster) }}" enctype="multipart/form-data" class="rounded-2xl border border-slate-200 bg-white p-6 shadow-sm space-y-4">
            ...
            <div class="grid gap-4 md:grid-cols-2">
                ...
                <div>
                    ...
                    <input type="text" name="tags" value="{{ old('tags', implode(', ', $cluster->tags ?? [])) }}" class="mt-1 w-full rounded-lg border-slate-300 text-sm focus:border-indigo-500 focus:ring-indigo-500" placeholder="seo, content">
                </div>
            </div>
            <div>
