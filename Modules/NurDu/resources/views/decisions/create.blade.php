    ...
    <div class="rounded-2xl border border-slate-200 bg-white p-6 shadow-sm">
        <form method="POST" action="{{ route('nurdu.decisions.store') }}" class="space-y-4">
            ...
            <div>
                ...
                <textarea name="description" rows="3" class="mt-1 block w-full rounded-lg  focus:border-indigo-500 focus:ring-indigo-500"></textarea>
            </div>
            <div>
            ...
            <div>
                ...
                <textarea name="justification" rows="3" class="mt-1 block w-full rounded-lg  focus:border-indigo-500 focus:ring-indigo-500"></textarea>
            </div>
            <div>
                <label class="block text-sm font-medium text-slate-700">{{ __('Decision Date') }}</label>
                <input type="date" name="decision_date" class="mt-1 block w-full rounded-lg  focus:border-indigo-500 focus:ring-indigo-500">
            </div>
