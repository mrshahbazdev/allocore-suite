                ...
                <tbody class="divide-y divide-slate-200">
                    @foreach ($items as $item)
                        <tr class="transition hover:bg-slate-50">
                            ...
                            <td class="px-5 py-4 text-sm text-slate-700"><span class="inline-flex rounded-full px-2.5 py-1 text-xs font-medium {{ strtolower($item->category) == 'approved' || strtolower($item->category) == 'active' || strtolower($item->category) == 'completed' || strtolower($item->category) == 'current' ? 'bg-emerald-100 text-emerald-700' : (strtolower($item->category) == 'archived' || strtolower($item->category) == 'on_hold' || strtolower($item->category) == 'paused' ? 'bg-slate-100 text-slate-600' : (strtolower($item->category) == 'proposed' || strtolower($item->category) == 'reviewing' || strtolower($item->category) == 'drafting' ? 'bg-amber-100 text-amber-700' : (strtolower($item->category) == 'draft' ? 'bg-slate-100 text-slate-600' : 'bg-slate-100 text-slate-700')))) }}">{{ $item->category }}</span></td>
