...
<div class="gmbh-create-layout">
    ...
    <div class="gmbh-create-left">
        ...
        <div class="card">
            ...
            <div class="form-grid">
                <div class="form-group col-span-2">
                    ...
                    <input type="text" name="name" class="form-control" placeholder="{{ __('z.B. GmbH Bewertung Q1 2024') }}" value="{{ old('name') }}" required>
                </div>
                <div class="form-group">
                    ...
                    @if($companies->isEmpty())
                        <div style="font-size:11px; color:#f59e0b; margin-top:4px;">
                            ⚠ <a href="{{ route('companies.create') }}" style="color:#f59e0b;">{{ __('Erstellen Sie zuerst ein Unternehmen') }}</a>
                        </div>
                    @endif
                </div>
                <div class="form-group">
                    <label class="form-label">{{ __('Analysejahr') }}</label>
        ...
        {{-- Revenue --}}
        <div class="card">
            <div class="card-title">{{ __('💰 Umsatz & Ergebnis') }}</div>
            <div class="form-grid">
                <div class="form-group">
                    <label class="form-label">{{ __('Umsatz aktuelles Jahr (€) *') }}</label>
        ...
        {{-- Balance Sheet --}}
        <div class="card">
            <div class="card-title">{{ __('📂 Bilanz') }}</div>
            <div class="form-grid">
                <div class="form-group">
        ...
        {{-- Customer Metrics --}}
        <div class="card">
            <div class="card-title">{{ __('👥 Kundenmetriken (Optional)') }}</div>
            <div class="form-grid">
                <div class="form-group">
                    <label class="form-label">{{ __('CAC — Customer Acquisition Cost (€)') }}</label>
                    <input type="number" step="0.01" name="cac" class="form-control" placeholder="500" value="{{ old('cac') }}">
                </div>
                <div class="form-group">
                    <label class="form-label">{{ __('LTV — Lifetime Value (€)') }}</label>
    ...
    <div class="gmbh-create-right">
        ...
        <div class="card">
            <div class="card-title">{{ __('🎯 Qualitative Bewertung') }}</div>

            <div class="form-group">
                <label class="form-label">{{ __('Management-Qualität (1–10) *') }}</label>
            ...
            <div class="form-group">
                <label class="form-label">{{ __('Markt & Wettbewerb (1–10) *') }}</label>
        ...
        <div class="card">
            <div class="card-title">{{ __('⚖️ Gewichtung der KPIs (manuell)') }}</div>
