...
@section('topbar-actions')
    <a href="{{ route('gmbh.show', $analysis) }}" class="btn btn-secondary btn-sm">{{ __('← Zurück') }}</a>
@endsection
@push('styles')
<style>
...
<div class="card" style="margin-bottom:16px;">
    ...
    <div class="form-grid">
        ...
        <div class="form-group">
            <label class="form-label">{{ __('Umsatz aktuell (€) *') }}</label>
        ...
        <div class="form-group">
            <label class="form-label">{{ __('Jahresüberschuss (€)') }}</label>
        ...
        <div class="form-group">
            <label class="form-label">{{ __('Cash (€)') }}</label>
        ...
        <div class="form-group">
            <label class="form-label">{{ __('CAC (€)') }}</label>
...
<div class="card" style="margin-bottom:16px;">
    ...
    <div style="font-size:11px; color:#64748b; margin-bottom:10px;">{{ __('Prozentanteile je KPI fuer diese Analyse. Die Summe darf 100% nicht ueberschreiten.') }}</div>
    @php
...
<button type="submit" class="btn btn-primary" style="width:100%; justify-content:center; padding:14px;">{{ __('🔢 Neu berechnen & speichern') }}</button>
</form>
</div>
@endsection
